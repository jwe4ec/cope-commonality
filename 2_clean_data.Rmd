...
cope_full_data_rev1 <- readRDS(file.path("data", "source", "cleaned_cope_data_randomized_rev1.rds"))
```
...
```{r pull session info}
session_info_path <- file.path("session_info")
dir.create(session_info_path)

sink(file.path(session_info_path, "2026.06.27_sessionInfo_for_cleaning_script.txt"))
sessionInfo()
sink()
```
