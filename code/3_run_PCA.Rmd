...
pkgs_pca <- c("tidyverse", "corrplot", "here")
...
pfs_nonimputed <- cope_ca_data_nonimputed_rev1 %>% 
...
#SS loadings    3.28
#Proportion Var 0.47
cope_ca_data_nonimputed_rev1$PC1 <- pca1$scores
...
cor(cope_ca_data_nonimputed_rev1$PC1, cope_ca_data_nonimputed_rev1$pi_pfs_mean)
#r=0.9993394
